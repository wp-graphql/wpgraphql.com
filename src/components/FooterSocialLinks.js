...
import { Flex, HStack, Button, chakra } from "@chakra-ui/react"
  ...
  <Flex border="0" maxW="720px" align="center" color="gray.400">
    <HStack spacing="5">
      ...
      <Button
        ...
        aria-label="Link to WPGraphQL on YouTube"
      >
        <FaYoutube />
        <chakra.span sx={{ display: "none" }}>
          Link to WPGraphQL on YouTube
        </chakra.span>
      </Button>
      <Button
        as="a"
        href="https://join.slack.com/t/wp-graphql/shared_invite/zt-3vloo60z-PpJV2PFIwEathWDOxCTTLA"
        aria-label="Join WPGraphQL on Slack"
      >
        <FaSlack />
        <chakra.span sx={{ display: "none" }}>
          Join WPGraphQL on Slack
        </chakra.span>
      </Button>
    </HStack>
  </Flex>
