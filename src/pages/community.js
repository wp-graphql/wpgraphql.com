    ...
    const features = [
      {
        ...
        content: "Github is where the development of the WPGraphQL plugin happens. If you’ve found a bug or have a feature request, open an issue for discussion. If you want to contribute code, feel free to open a pull request.",
      },
      {
        icon: FaSlack,
        title: "Slack",
        link: "https://join.slack.com/t/wp-graphql/shared_invite/zt-3vloo60z-PpJV2PFIwEathWDOxCTTLA",
        content: "The WPGraphQL Slack is a great place to communicate in real-time. Ask questions, discuss features, get to know other folks using WPGraphQL.",
      },
      {
        icon: FaTwitter,
        title: "Twitter",
        link: "https://twitter.com/wpgraphql",
        content: "Follow WPGraphQL on Twitter to keep up with the latest news about the plugin and the WordPress and GraphQL ecosystems. Only occasional trolling.",
      },
      {
        icon: FaYoutube,
        title: "Youtube",
        link: "http://www.youtube.com/channel/UCwav5UKLaEufn0mtvaFAkYw",
        content: "Follow WPGraphQL on Youtube to see helpful videos, demos, and case-studies on how WPGraphQL can be used.",
      },
    ]
