  ...
  return (
    ...
    >
      <WrapItem key="dfuzr" bg="#ee0d00" p="1" rounded="md">
        <a href={"https://www.dfuzr.com/"} target="_blank" rel="noreferrer">
          <Tooltip
            ...
            aria-label="Dfuzr Industries Logo"
            placement="top"
          >
            <Image
              alt="Dfuzr Logo"
      ...
      <WrapItem key="Harness" bg="white" p="1" rounded="md">
        <a href={"http://www.harnessup.com/"} target="_blank" rel="noreferrer">
          <Tooltip
            ...
            aria-label="Harness Software Logo"
            placement="top"
          >
            <Image
      ...
      <WrapItem key="Denver Post" bg="white" p="3" rounded="md">
        <a
          href={"https://www.denverpost.com/"}
          target="_blank"
          rel="noreferrer"
        >
          <Tooltip
            label="Denver Post"
            aria-label="Denver Post Logo"
            placement="top"
          >
            <Image
      ...
      <WrapItem key="Twin Cities" bg="white" p="3" rounded="md">
        <a
          href={"https://www.twincities.com/"}
          target="_blank"
          rel="noreferrer"
        >
          <Tooltip
            label="Twin Cities"
            aria-label="Twin Cities Logo"
            placement="top"
          >
            <Image
      ...
      <WrapItem key="Quartz" bg="#111111" p="3" rounded="md">
        <a href={"https://qz.com/"} target="_blank" rel="noreferrer">
          <Tooltip label="Quartz" aria-label="Quartz Logo" placement="top">
            <Image
              alt="Quartz Logo"
              h="60px"
              w="auto"
      ...
      <WrapItem key="Hope Lab" bg="white" p="3" rounded="md">
        <a href={"https://hopelab.org/"} target="_blank" rel="noreferrer">
          <Tooltip label="Hope Lab" aria-label="Hope Lab Logo" placement="top">
            <Image
              alt="Hope Lab Logo"
              h="60px"
              w="auto"
      ...
      <WrapItem key="Credit Karma" bg="white" p="1" rounded="md">
        <a
          href={"https://blog.creditkarma.com/"}
          target="_blank"
          rel="noreferrer"
        >
          <Tooltip
      ...
      <WrapItem key="Gatsby" bg="white" p="1" rounded="md">
        <a href={"https://gatsbyjs.com/"} target="_blank" rel="noreferrer">
          <Tooltip label="Gatsby" aria-label="Gatsby Logo" placement="top">
            <Image
              alt="Gatsby Logo"
              h="60px"
              w="auto"
      ...
      <WrapItem key="The Players Tribune" bg="white" p="2" rounded="md">
        <a
          href={"https://www.theplayerstribune.com/"}
          target="_blank"
          rel="noreferrer"
        >
          <Tooltip
      ...
      <WrapItem key="Zillow" bg="white" p="1" rounded="md">
        <a href={"https://www.zillow.com/"} target="_blank" rel="noreferrer">
          <Tooltip label="Zillow" aria-label="Zillow" placement="top">
            <Image
              alt="Zillow Logo"
              h="60px"
              w="auto"
